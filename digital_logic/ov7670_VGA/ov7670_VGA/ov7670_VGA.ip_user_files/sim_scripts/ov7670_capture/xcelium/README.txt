...
#
# Generated by export_simulation on Sat Dec 20 17:07:53 +0800 2025
#
################################################################################
...
'-reset_run' switch to the './ov7670_capture.sh' script.

./ov7670_capture.sh -reset_run
...
./ov7670_capture.sh -noclean_files

For more information on the script, please type './ov7670_capture.sh -help'.
