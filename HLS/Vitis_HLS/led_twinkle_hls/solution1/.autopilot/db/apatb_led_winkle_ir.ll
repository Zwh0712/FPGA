; ModuleID = 'D:/FPGA/FPGA/HLS/Vitis_HLS/led_twinkle_hls/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_led_winkle_ir(%struct.ap_uint* %led) local_unnamed_addr #0 {
entry:
  %led_copy1 = alloca %struct.ap_uint, align 512
  call fastcc void @copy_in(%struct.ap_uint* %led, %struct.ap_uint* nonnull align 512 %led_copy1)
  call void @apatb_led_winkle_hw(%struct.ap_uint* %led_copy1)
  call fastcc void @copy_out(%struct.ap_uint* %led, %struct.ap_uint* nonnull align 512 %led_copy1)
  ret void
}
...
declare void @apatb_led_winkle_hw(%struct.ap_uint*)

define void @led_winkle_hw_stub_wrapper(%struct.ap_uint*) #6 {
entry:
  call void @copy_out(%struct.ap_uint* null, %struct.ap_uint* %0)
  call void @led_winkle_hw_stub(%struct.ap_uint* %0)
  call void @copy_in(%struct.ap_uint* null, %struct.ap_uint* %0)
  ret void
}

declare void @led_winkle_hw_stub(%struct.ap_uint*)
